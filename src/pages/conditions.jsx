        ...
        <ol type="I" className="t-withe">
          <li>
            ...
            <ol type="a">
              <li>
                ...
                crear una red social. Para ello, es necesario estar registrada y
                suscrita a los servicios ofrecidos.
              </li>
              <li>
                La descarga e instalación de UnitedWom son de carácter gratuito,
                sin perjuicio de que algunas actividades puedan ser de pago.
              </li>
              <li>
                En UnitedWom también se ofrecen medios de contacto con
                UnitedWom, a efectos de poder formular dudas, quejas o
                sugerencias.
              </li>
              <li>
                La App de UnitedWom está diseñada para ser empleada en
                dispositivos tanto teléfonos móviles como tablets con acceso a
                Internet por mujeres.
              </li>
            </ol>
          </li>
          <li>
            ...
            <ol type="a">
              <li>
                ...
                pago o gratuitos allí ofrecidos en cada momento.
              </li>
              <li>
          ...
          <li>
            ...
            <ol type="a">
              <li>
                ...
                dispositivos móviles (teléfonos móviles, tablets). Para ello, es
                necesario estar registrada y suscrita a los servicios ofrecidos.
                La descarga e instalación de UnitedWom son de carácter gratuito,
                sin perjuicio de que algunos de sus servicios puedan ser de
                pago.
              </li>
            </ol>
          </li>
            ...
            <ol type="a">
              <li>
                ...
                <p className="t-description">
                  ...
                  Términos y Condiciones de Uso, comprobando los cambios
                ...
                <p className="t-description">
                  ...
                  similares sin el consentimiento previo de UnitedWom.
                </p>
                <p className="t-description">
            ...
            <ol type="a">
              ...
              <li>
                ...
                <p className="t-description">
                  ...
                  dentro de UnitedWom, sin que quepa lugar para cualquier
                  conducta inapropiada. Los actos de discriminación no serán
                  tolerados bajo ningún aspecto ni contenido alguno.
                </p>
              </li>
            </ol>
          </li>
          ...
          <li>
            ...
            <ol type="a">
              ...
              <li>
                UnitedWom dedica todos sus métodos para proteger los sistemas y
                los contenidos incluidos en la App, a cuyo efecto cumple los
                estándares de seguridad habituales en Internet, no siendo
                posible garantizar en un 100% en relación a las intrusiones o
                pérdidas de información que puedan producirse. Así también no
              ...
              <li>
                ...
                vigilar la legalidad y cumplimiento de esta Licencia de Uso en
                lo relativo a contenidos. De esta forma, en virtud de lo
                dispuesto en el artículo 16 de la Ley 34/2002, de 11 de julio,
                de Servicios de la Sociedad de la Información y de Comercio
                Electrónico, no seremos responsables en ningún caso de la
                información, imágenes, opiniones, alusiones o contenidos de
                cualquier tipo que comuniques, alojes, transmitas, pongas a
                disposición o exhibas a través de la App. No realizamos
                manifestaciones ni garantías expresas sobre ningún contenido que
                provenga de un tercero ajeno a UnitedWom.
              </li>
              <li>
          ...
          <li>
            ...
            <ol type="a">
              ...
              <li>
                ...
                que en los mismos no existan amenazas informáticas, virus o
                malware o que alberguen contenido ilícito o inadecuado u otros
                enlaces que, a su vez, lleven a sitios con alguna o varias de
