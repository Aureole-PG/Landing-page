    ...
    <section id="about" className="about-height pink-green-background">
      <div className="container container-padding">
        ...
        <p className="t-paragraph">
          ...
          etapas en nuestras vidas, algunas duras y otras felices.
        </p>
        <p className="t-paragraph">
        ...
        <p className="t-paragraph">
          ...
          UNIDAS nos hacemos más fuertes, <br />
          Que con APOYO llega la calma, <br />
          Que CONECTANDO somos más libres, <br />
          Que COMPARTIENDO se abren nuevos caminos y oportunidades.
        </p>
        <p className="t-paragraph">
        ...
        <p className="t-paragraph">
          ...
          Conectar con tu fuerza <br />
          Descubrir tu energía <br />
          Manifestar lo que deseas y, por tanto, recibir todo eso que te hace
          sentir plena.
        </p>
        <p className="t-paragraph">
          A todo esto, que tiene que ver con lo que proyectamos y por tanto, lo
          que atraemos, en UnitedWom le hemos llamado el <b>EFECTO UnitedWom</b>
        </p>
        <p className="t-paragraph">
          Una aplicación donde podrás acceder de manera gratuita e ilimitada
          allá donde estés en cada momento a todo tipo de actividades que otras
