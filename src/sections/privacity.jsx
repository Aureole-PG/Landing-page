  ...
  return (
    <div className="height black-green-background nav-height">
      <div className="container container-padding">
        <h2 className="t-title">Políticas de privacidad</h2>
        <p className="t-paragraph">
          Aviso Legal UnitedWom, S.L., en cumplimiento de la Ley 34/2002, de 11
          de julio, de Servicios de la Sociedad de la Información y de Comercio
          Electrónico, le informa de que:
        </p>
        <p className="t-paragraph">
          Su denominación social es UNITEDWOM, S.L. Su NIF es B42780791. Su
          domicilio se ubica en Calle Padre Ramón María Aller, 6, 36201, Vigo
          ...
          hola@unitedwom.com Política de Privacidad Los datos personales
          vinculados a esta página web respetan las exigencias del Reglamento
          ...
          de estos datos, la Ley Orgánica 3/2018, de 5 de diciembre, de
          Protección de Datos Personales y garantía de los derechos digitales y
          demás legislación vigente en materia de protección de datos.
        </p>
        <p className="t-paragraph">
          ¿Quién es el Responsable del tratamiento de sus datos?
        </p>
        <p className="t-paragraph">
          UNITEDWOM, S.L., NIF: B42780791 Dirección: Calle Padre Ramón María
          Aller, 6, 36201, Vigo (Pontevedra) España. Correo electrónico:
          hola@unitedwom.com
        </p>
        <p className="t-paragraph">
        ...
        <p className="t-paragraph">
          No se cederán sus datos a terceros. Se comunicarán a nuestros
          encargados de tratamiento cuando sea necesario para la correcta
          prestación de los servicios contratados a los mismos.
        </p>
        <p className="t-paragraph">
        ...
        <p className="t-paragraph">
          ...
          comunicado o se van a comunicar a un tercero. Rectificación: derecho a
          solicitar la rectificación de los datos inexactos y a que se completen
          los datos personales incompletos.
        </p>
        <p className="t-paragraph">
        ...
        <p className="t-paragraph">
          ...
          cese en el tratamiento. Limitación del Tratamiento: derecho a
          solicitar, en las circunstancias establecidas legalmente, que no se
          traten sus datos más allá de la mera conservación de los mismos.
        ...
        <p className="t-paragraph">
          ...
          correo electrónico lopd@cloverwin.com. UNITEDWOM, S.L., pone a su
        ...
        <p className="t-paragraph">
          ...
          utilizar la sede electrónica: https://sedeagpd.gob. En ambos casos,
          deberá acompañar la documentación pertinente.
        </p>
      </div>
    </div>
  );
